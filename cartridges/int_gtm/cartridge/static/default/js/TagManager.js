    ...
    var observer = new MutationObserver(function (mutationsList) {
        for (var mutation of mutationsList) {
            if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
                ...
                var targetNodeForCheckout = mutation.target.querySelector('.container.data-checkout-stage');
              
                var targetNodeForPdp = mutation.target.querySelector('.product-wrapper');
